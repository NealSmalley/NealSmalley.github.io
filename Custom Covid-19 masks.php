<?php
    include 'header.php';
?>
<h1><center>Custom Covid-19 Masks</center></h1>
<!DOCTYPE html> 
<html>
<head>
<title>Custom Covid-19 Masks</title>
<?php include 'header.php';?><style><?php include 'CSS/covid-19.css';?></style>
<div id="app"></div>
</head>
<body>
  <header>
...
<head>
  ...
  * {box-sizing: border-box}
  ...
  <div class="mySlides fade">
    ...
    <center><img src="img/bane1.jpg" style="width:50%" alt="bane"></center>
    <div class="text">bane no paint</div>
  </div>
  
  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <center><img src="img/vader.jpg" style="width:50%" alt="vader"></center>
    <div class="text">vader before paint</div>
  </div>
  ...
  <section class="features">
    <figure>
      <img src="img/bane2.jpg" alt="Bane mask">
      <figcaption>Bane mask</figcaption>
    </figure>
    <figure>
      <img src="img/vader.jpg" alt="Vader mask">
      <figcaption>Vader mask</figcaption>
    </figure>
    <figure>
      <img src="img/bunny mask.png" alt="bunny mask">
